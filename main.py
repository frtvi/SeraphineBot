...
class SubButton(discord.ui.View):
    def __init__(self):
        ...
        botaourl = discord.ui.Button(label="Confira o github do criador",url="https://github.com/frtvi")
...
async def sync(ctx,guild=None):
    ...
    await ctx.send("Eu canto pra ajudar cada um a se encontrar, o palco só facilita!",view=SubButton())
